...
pub static CATALOG: &[CatalogModel] = &[
    ...
    CatalogModel {
        ...
        languages: &["ar"],
        files: &[RemoteFile { url: url!(GH_TTS, "/vits-piper-ar_JO-SA_miro_V2-high.tar.bz2"), sha256: Some("2afdb963a8e314a31362faf197ce6c25eb659d9279061616645e2452d22054de"), dest: "", archive: true, size_bytes: 66_977_293 }],
        quality: 5,
        min_ram_gb: 1,
    ...
    CatalogModel {
        ...
        kind: ModelKind::Tts,
        engine: Engine::Piper,
        name: "Dii (Arabic, female, high quality)",
        languages: &["ar"],
        files: &[RemoteFile { url: url!(GH_TTS, "/vits-piper-ar_JO-SA_dii-high.tar.bz2"), sha256: Some("9098ae5b3785a5f0fd3edd1ba5f8bd4d212915bd5a1bcd08cc012a4c818103ba"), dest: "", archive: true, size_bytes: 66_982_233 }],
        quality: 5,
        min_ram_gb: 1,
        license: "see model card",
        gender: "female",
    ...
    CatalogModel {
        ...
        kind: ModelKind::Tts,
        engine: Engine::Piper,
        name: "Dii (Arabic, female, compact)",
        languages: &["ar"],
        files: &[RemoteFile { url: url!(GH_TTS, "/vits-piper-ar_JO-SA_dii-high-int8.tar.bz2"), sha256: Some("02f6f990b31323b7f36c8c68c3a5dc7f7c9f3db555c632310693cf7d82b9540e"), dest: "", archive: true, size_bytes: 21_998_588 }],
        quality: 3,
        min_ram_gb: 1,
        license: "see model card",
        gender: "female",
