...
const SETTINGS: Settings = {
  ...
  language: {
    ...
    entries: [
      { code: "en", displayName: "English", direction: "ltr", sttLanguage: "en", ttsVoice: "auto", builtIn: true },
      { code: "ar", displayName: "Arabic", direction: "rtl", sttLanguage: "ar", ttsVoice: "auto", builtIn: true },
      { code: "de", displayName: "German", direction: "ltr", sttLanguage: "de", ttsVoice: "auto", builtIn: true },
    ],
    arabicTashkeelEnabled: false,
  ...
  tts: { speakResponses: false, speed: 1, volume: 1, outputDevice: null, preferredGender: "any", voiceHardware: {}, cacheMb: 500, speakAfterReply: false, orpheusModels: {} },
